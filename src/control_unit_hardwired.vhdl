...
begin
    ...
    process (clk)
        ...
        begin
            case timer is
                when 0 => r_src_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => mar_in <= '1';
                when 1 => r_src_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 6 => mdr_out <= '1'; mar_in <= '1';
                when 7 => r_src_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => tmp1_in <= '1'; alu_r_plus_1 <= '1';
                when 1 => alu_out <= '1';
                when 2 => tmp1_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 1 => alu_out <= '1';
                when 2 => mar_in <= '1';
                when 3 => mar_out <= '1'; alu_r_plus_1 <= '1';
                when 4 => alu_out <= '1';
        ...
        begin
            case timer is
                when 0 => tmp1_in <= '1'; alu_r_plus_1 <= '1';
                when 1 => alu_out <= '1';
                when 2 => pc_out <= '1'; mar_in <= '1'; rd <= '1';
                when 3 => pc_out <= '1'; alu_r_plus_1 <= '1';
                when 4 => alu_out <= '1'; pc_in <= '1';
                when 5 => mdr_out <= '1'; tmp0_in <= '1';
                when 6 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 7 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 8 => mdr_out <= '1'; mar_in <= '1';
        ...
        begin
            case timer is
                ...
                when 7 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 8 => mdr_out <= '1'; mar_in <= '1';
                when 9 => r_src_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 6 => mdr_out <= '1'; tmp1_in <= '1';
                when 7 => mar_in <= '1';
                when 8 => tmp1_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 6 => mdr_out <= '1'; tmp1_in <= '1';
                when 7 => mar_in <= '1';
                when 8 => mar_out <= '1'; alu_r_plus_1 <= '1';
                when 9 => alu_out <= '1';
        ...
        begin
            case timer is
                ...
                when 5 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 6 => mdr_out <= '1'; tmp1_in <= '1';
                when 7 => pc_out <= '1'; mar_in <= '1'; rd <= '1';
                when 8 => pc_out <= '1'; alu_r_plus_1 <= '1';
                when 9 => alu_out <= '1'; pc_in <= '1';
                when 10 => mdr_out <= '1'; tmp0_in <= '1';
                when 11 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 12 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 13 => mdr_out <= '1'; mar_in <= '1';
                when 14 => tmp1_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 7 => mdr_out <= '1'; tmp1_in <= '1';
                when 8 => mar_in <= '1';
                when 9 => mar_out <= '1'; alu_r_plus_1 <= '1';
                when 10 => alu_out <= '1';
                when 11 => tmp1_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        ...
        begin
            case timer is
                ...
                when 6 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 7 => mdr_out <= '1'; tmp1_in <= '1';
                when 8 => pc_out <= '1'; mar_in <= '1'; rd <= '1';
                when 9 => pc_out <= '1'; alu_r_plus_1 <= '1';
                when 10 => alu_out <= '1'; pc_in <= '1';
                when 11 => mdr_out <= '1'; tmp0_in <= '1';
                when 12 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 13 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 14 => mdr_out <= '1'; mar_in <= '1';
                when 15 => tmp1_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => r_src_out <= '1'; tmp0_in <= '1';
                when 1 => r_dst_out <= '1'; alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 2 => alu_out <= '1'; r_src_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => alu_r_minus_1 <= '1';
                when 1 => alu_out <= '1';
                when 2 => r_src_out <= '1'; tmp0_in <= '1';
                when 3 => r_dst_out <= '1'; alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 4 => alu_out <= '1'; r_src_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => tmp1_in <= '1'; alu_r_plus_1 <= '1';
                when 1 => alu_out <= '1';
                when 2 => tmp0_in <= '1'; alu_r_plus_1 <= '1';
                when 3 => alu_out <= '1';
        ...
        begin
            case timer is
                ...
                when 6 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 7 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 8 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
        ...
        begin
            case timer is
                ...
                when 8 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 9 => mdr_out <= '1'; tmp0_in <= '1';
                when 10 => r_src_out <= '1'; alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 11 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 5 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 6 => mdr_out <= '1'; tmp1_in <= '1';
                when 7 => tmp0_in <= '1'; alu_r_plus_1 <= '1';
                when 8 => alu_out <= '1';
                when 9 => tmp1_out <= '1'; alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
        ...
        begin
            case timer is
                ...
                when 11 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 12 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 13 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 14 => mdr_out <= '1'; tmp0_in <= '1';
                when 15 => tmp1_out <= '1'; alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
        ...
        begin
            case timer is
                ...
                when 6 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 7 => mdr_out <= '1'; tmp1_in <= '1';
                when 8 => tmp0_in <= '1'; alu_r_plus_1 <= '1';
                when 9 => alu_out <= '1';
                when 10 => tmp1_out <= '1'; alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 11 => alu_out <= '1'; r_dst_in <= '1';
                when others => end_flag <= 1;
        ...
        begin
            case timer is
                ...
                when 8 => alu_r_minus_1 <= '1';
                when 9 => alu_out <= '1';
                when 10 => tmp1_out <= '1'; tmp0_in <= '1';
                when 11 => r_dst_out <= '1'; alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
        ...
        begin
            case timer is
                ...
                when 12 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 13 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 14 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 15 => mdr_out <= '1'; tmp0_in <= '1';
                when 16 => tmp1_out <= '1'; alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
        ...
        begin
            case timer is
                when 0 => r_src_out <= '1'; tmp0_in <= '1';
                when 1 => r_dst_out <= '1'; alu_r_plus_l_plus_c <= '1';
                when 2 => alu_out <= '1'; r_src_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 8 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 9 => mdr_out <= '1'; tmp0_in <= '1';
                when 10 => r_src_out <= '1'; alu_r_plus_l_plus_c <= '1';
                when 11 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 13 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 14 => mdr_out <= '1'; tmp0_in <= '1';
                when 15 => tmp1_out <= '1'; alu_r_plus_l_plus_c <= '1';
                when 16 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 9 => alu_out <= '1';
                when 10 => tmp1_out <= '1'; tmp0_in <= '1';
                when 11 => r_dst_out <= '1'; alu_r_plus_l_plus_c <= '1';
                when 12 => alu_out <= '1'; r_dst_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 14 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 15 => mdr_out <= '1'; tmp0_in <= '1';
                when 16 => tmp1_out <= '1'; alu_r_plus_l_plus_c <= '1';
                when 17 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 7 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 8 => mdr_out <= '1'; tmp0_in <= '1';
                when 9 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 10 => tmp1_out <= '1'; tmp0_in <= '1';
                when 11 => alu_out <= '1'; tmp1_in <= '1';
        ...
        begin
            case timer is
                ...
                when 3 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 4 => mdr_out <= '1'; tmp0_in <= '1';
                when 5 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 6 => tmp1_out <= '1'; tmp0_in <= '1';
                when 7 => alu_out <= '1'; tmp1_in <= '1';
                when 8 => tmp1_out <= '1'; alu_c_eq_0 <= '1'; alu_r_minus_l_minus_c <= '1';
                when 9 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        ...
        begin
            case timer is
                ...
                when 8 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 9 => mdr_out <= '1'; tmp0_in <= '1';
                when 10 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 11 => tmp1_out <= '1'; tmp0_in <= '1';
                when 12 => alu_out <= '1'; tmp1_in <= '1';
        ...
        begin
            case timer is
                when 0 => alu_r_minus_1 <= '1';
                when 1 => alu_out <= '1';
                when 2 => tmp1_in <= '1'; alu_r_plus_1 <= '1';
                when 3 => alu_out <= '1';
                when 4 => r_src_out <= '1'; tmp0_in <= '1';
                when 5 => tmp1_out <= '1'; alu_c_eq_0 <= '1'; alu_r_minus_l_minus_c <= '1';
                when 6 => alu_out <= '1'; r_dst_in <= '1';
        ...
        begin
            case timer is
                ...
                when 12 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 13 => mdr_out <= '1'; tmp0_in <= '1';
                when 14 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 15 => tmp1_out <= '1'; tmp0_in <= '1';
                when 16 => alu_out <= '1'; tmp1_in <= '1';
        ...
        begin
            case timer is
                ...
                when 13 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 14 => mdr_out <= '1'; tmp0_in <= '1';
                when 15 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 16 => tmp1_out <= '1'; tmp0_in <= '1';
                when 17 => alu_out <= '1'; tmp1_in <= '1';
                when 18 => tmp1_out <= '1'; alu_c_eq_0 <= '1'; alu_r_minus_l_minus_c <= '1';
                when 19 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 9 => alu_out <= '1';
                when 10 => tmp1_out <= '1'; tmp0_in <= '1';
                when 11 => r_dst_out <= '1'; alu_c_eq_0 <= '1'; alu_r_minus_l_minus_c <= '1';
                when 12 => alu_out <= '1'; r_dst_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 14 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 15 => mdr_out <= '1'; tmp0_in <= '1';
                when 16 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 17 => tmp1_out <= '1'; tmp0_in <= '1';
                when 18 => alu_out <= '1'; tmp1_in <= '1';
                when 19 => tmp1_out <= '1'; alu_c_eq_0 <= '1'; alu_r_minus_l_minus_c <= '1';
                when 20 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 16 => tmp1_out <= '1'; tmp0_in <= '1';
                when 17 => alu_out <= '1'; tmp1_in <= '1';
                when 18 => tmp1_out <= '1'; alu_r_minus_l_minus_c <= '1';
                when 19 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 9 => alu_out <= '1';
                when 10 => tmp1_out <= '1'; tmp0_in <= '1';
                when 11 => r_dst_out <= '1'; alu_r_minus_l_minus_c <= '1';
                when 12 => alu_out <= '1'; r_dst_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 17 => tmp1_out <= '1'; tmp0_in <= '1';
                when 18 => alu_out <= '1'; tmp1_in <= '1';
                when 19 => tmp1_out <= '1'; alu_r_minus_l_minus_c <= '1';
                when 20 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => r_src_out <= '1'; tmp0_in <= '1';
                when 1 => r_dst_out <= '1'; alu_r_not_l <= '1';
                when 2 => alu_out <= '1'; r_src_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 8 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 9 => mdr_out <= '1'; tmp0_in <= '1';
                when 10 => r_src_out <= '1'; alu_r_not_l <= '1';
                when 11 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 13 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 14 => mdr_out <= '1'; tmp0_in <= '1';
                when 15 => tmp1_out <= '1'; alu_r_not_l <= '1';
                when 16 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 9 => alu_out <= '1';
                when 10 => tmp1_out <= '1'; tmp0_in <= '1';
                when 11 => r_dst_out <= '1'; alu_r_not_l <= '1';
                when 12 => alu_out <= '1'; r_dst_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 14 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 15 => mdr_out <= '1'; tmp0_in <= '1';
                when 16 => tmp1_out <= '1'; alu_r_not_l <= '1';
                when 17 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => r_src_out <= '1'; tmp0_in <= '1';
                when 1 => r_dst_out <= '1'; alu_r_or_l <= '1';
                when 2 => alu_out <= '1'; r_src_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 8 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 9 => mdr_out <= '1'; tmp0_in <= '1';
                when 10 => r_src_out <= '1'; alu_r_or_l <= '1';
                when 11 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 13 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 14 => mdr_out <= '1'; tmp0_in <= '1';
                when 15 => tmp1_out <= '1'; alu_r_or_l <= '1';
                when 16 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 9 => alu_out <= '1';
                when 10 => tmp1_out <= '1'; tmp0_in <= '1';
                when 11 => r_dst_out <= '1'; alu_r_or_l <= '1';
                when 12 => alu_out <= '1'; r_dst_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 14 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 15 => mdr_out <= '1'; tmp0_in <= '1';
                when 16 => tmp1_out <= '1'; alu_r_or_l <= '1';
                when 17 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => r_src_out <= '1'; tmp0_in <= '1';
                when 1 => r_dst_out <= '1'; alu_r_xnor_l <= '1';
                when 2 => alu_out <= '1'; r_src_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 8 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 9 => mdr_out <= '1'; tmp0_in <= '1';
                when 10 => r_src_out <= '1'; alu_r_xnor_l <= '1';
                when 11 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 13 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 14 => mdr_out <= '1'; tmp0_in <= '1';
                when 15 => tmp1_out <= '1'; alu_r_xnor_l <= '1';
                when 16 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 9 => alu_out <= '1';
                when 10 => tmp1_out <= '1'; tmp0_in <= '1';
                when 11 => r_dst_out <= '1'; alu_r_xnor_l <= '1';
                when 12 => alu_out <= '1'; r_dst_in <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 14 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 15 => mdr_out <= '1'; tmp0_in <= '1';
                when 16 => tmp1_out <= '1'; alu_r_xnor_l <= '1';
                when 17 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 4 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 5 => alu_out <= '1'; mar_in <= '1';
                when 6 => alu_zero <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 4 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 5 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 6 => mdr_out <= '1'; alu_c_eq_0 <= '1'; alu_rrc <= '1';
                when 7 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => mar_in <= '1'; rd <= '1';
                when 1 => mdr_out <= '1'; alu_c_eq_0 <= '1'; alu_rrc <= '1';
                when 2 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 5 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 6 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 7 => mdr_out <= '1'; alu_c_eq_0 <= '1'; alu_rrc <= '1';
                when 8 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 4 => alu_c_eq_0 <= '1'; alu_r_plus_l_plus_c <= '1';
                when 5 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 6 => mdr_out <= '1'; alu_c_eq_0 <= '1'; alu_rlc <= '1';
                when 7 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => mar_in <= '1'; rd <= '1';
                when 1 => mdr_out <= '1'; alu_c_eq_0 <= '1'; alu_rlc <= '1';
                when 2 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                ...
                when 5 => alu_out <= '1'; mar_in <= '1'; rd <= '1';
                when 6 => mdr_out <= '1'; mar_in <= '1'; rd <= '1';
                when 7 => mdr_out <= '1'; alu_c_eq_0 <= '1'; alu_rlc <= '1';
                when 8 => alu_out <= '1'; mdr_in <= '1'; wr <= '1';
                when others => end_flag <= 1;
            end case;
        end procedure;
        ...
        begin
            case timer is
                when 0 => ir_addr_out <= '1'; tmp0_in <= '1';
        ...
        begin
            case timer is
                ...
                when 1 => ir_addr_out <= '1'; tmp0_in <= '1';
        ...
        begin
            ...
            if ir_data(15 downto 8) = "11110000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then inc_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11110000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then inc_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11110000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then inc_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11110000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then inc_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11110000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then inc_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11110000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then inc_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11110000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then inc_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11110000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then inc_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11110001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then dec_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11110001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then dec_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11110001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then dec_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11110001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then dec_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11110001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then dec_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11110001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then dec_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11110001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then dec_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11110001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then dec_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11110010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then clr_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11110010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then clr_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11110010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then clr_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11110010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then clr_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11110010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then clr_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11110010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then clr_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11110010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then clr_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11110010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then clr_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11110011" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then inv_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11110011" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then inv_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11110011" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then inv_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11110011" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then inv_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11110011" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then inv_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11110011" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then inv_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11110011" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then inv_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11110011" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then inv_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11110100" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then lsr_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11110100" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then lsr_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11110100" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then lsr_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11110100" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then lsr_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11110100" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then lsr_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11110100" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then lsr_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11110100" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then lsr_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11110100" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then lsr_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11110101" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then ror_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11110101" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then ror_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11110101" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then ror_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11110101" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then ror_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11110101" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then ror_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11110101" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then ror_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11110101" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then ror_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11110101" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then ror_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11110110" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then rrc_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11110110" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then rrc_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11110110" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then rrc_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11110110" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then rrc_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11110110" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then rrc_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11110110" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then rrc_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11110110" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then rrc_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11110110" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then rrc_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11110111" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then asr_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11110111" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then asr_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11110111" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then asr_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11110111" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then asr_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11110111" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then asr_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11110111" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then asr_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11110111" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then asr_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11110111" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then asr_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11111000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then lsl_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11111000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then lsl_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11111000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then lsl_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11111000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then lsl_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11111000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then lsl_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11111000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then lsl_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11111000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then lsl_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11111000" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then lsl_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11111001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then rol_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11111001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then rol_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11111001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then rol_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11111001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then rol_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11111001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then rol_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11111001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then rol_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11111001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then rol_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11111001" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then rol_at_x_r_at_x_r; end if;
            if ir_data(15 downto 8) = "11111010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "000" then rlc_at_x_r_r; end if;
            if ir_data(15 downto 8) = "11111010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "001" then rlc_at_x_r_r_plus; end if;
            if ir_data(15 downto 8) = "11111010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "010" then rlc_at_x_r_minus_r; end if;
            if ir_data(15 downto 8) = "11111010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "011" then rlc_at_x_r_x_r; end if;
            if ir_data(15 downto 8) = "11111010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "100" then rlc_at_x_r_at_r; end if;
            if ir_data(15 downto 8) = "11111010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "101" then rlc_at_x_r_at_r_plus; end if;
            if ir_data(15 downto 8) = "11111010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "110" then rlc_at_x_r_at_minus_r; end if;
            if ir_data(15 downto 8) = "11111010" and ir_data(11 downto 9) = "111" and ir_data(5 downto 3) = "111" then rlc_at_x_r_at_x_r; end if;
            if ir_data(15 downto 10) = "000000" then br; end if;
            if ir_data(15 downto 10) = "000001" then beq; end if;
            if ir_data(15 downto 10) = "000010" then bne; end if;
            if ir_data(15 downto 10) = "000011" then blo; end if;
            if ir_data(15 downto 10) = "110000" then bls; end if;
            if ir_data(15 downto 10) = "110001" then bhi; end if;
            if ir_data(15 downto 10) = "110011" then bhs; end if;
            if ir_data(15 downto 12) = "1010" then hlt; end if;
            if ir_data(15 downto 12) = "1011" then nop; end if;
            if ir_data(15 downto 10) = "110100" and ir_data(11 downto 9) = "011" then jsr_x_r; end if;
            if ir_data(15 downto 10) = "111001" then rts; end if;
            if ir_data(15 downto 10) = "111010" then int; end if;
            if ir_data(15 downto 10) = "111011" then iret; end if;
        end procedure;
    begin
